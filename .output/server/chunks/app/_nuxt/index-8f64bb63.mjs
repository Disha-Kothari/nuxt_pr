...
import { u as useNuxtApp, d as defineAppConfig } from '../server.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}>From Test Component</div>`);
    };
  }
};
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  const _component_Test = __nuxt_component_0;
  _push(`<div${ssrRenderAttrs(_attrs)}><h1>Welcome to the home/Index page</h1>`);
...
//# sourceMappingURL=index-8f64bb63.mjs.map
